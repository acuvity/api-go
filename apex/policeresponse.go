...
func (o *PoliceResponse) EncryptAttributes(encrypter elemental.AttributeEncrypter) (err error) {
	...
	if o.Error != nil {
		if err := o.Error.EncryptAttributes(encrypter); err != nil {
			return fmt.Errorf("unable to encrypt ref attribute 'Error' for 'PoliceResponse' (%s): %w", o.Identifier(), err)
		}
	}
...
func (o *PoliceResponse) DecryptAttributes(encrypter elemental.AttributeEncrypter) (err error) {
	...
	if o.Error != nil {
		if err := o.Error.DecryptAttributes(encrypter); err != nil {
			return fmt.Errorf("unable to decrypt ref attribute 'Error' for 'PoliceResponse' (%s): %w", o.Identifier(), err)
		}
	}
