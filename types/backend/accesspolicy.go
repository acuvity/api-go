...
func (o *AccessPolicy) Patch(sparse elemental.SparseIdentifiable) {
	...
	if so.Enforcement != nil {
		o.Enforcement = *so.Enforcement
	}
...
type SparseAccessPolicy struct {
	...
	// If set, just log the decision, but don't enforce it.
	Enforcement *bool `json:"enforcement,omitempty" msgpack:"enforcement,omitempty" bson:"enforcement,omitempty" mapstructure:"enforcement,omitempty"`
...
type mongoAttributesAccessPolicy struct {
	...
	Enforcement         bool                    `bson:"enforcement"`
...
type mongoAttributesSparseAccessPolicy struct {
	...
	Enforcement         *bool                    `bson:"enforcement,omitempty"`
	ImportHash          *string                  `bson:"importhash,omitempty"`
	ImportLabel         *string                  `bson:"importlabel,omitempty"`
