...
Creates a new digest report.

##### `DELETE /digestreports/:id`

Delete a digest report configuration given its identifier.

##### `GET /digestreports/:id`

Retrieve a digest report configuration given its identifier.

##### `PUT /digestreports/:id`

Update a digest report configuration given its identifier.
