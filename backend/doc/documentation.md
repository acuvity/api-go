...
Type: `enum(Administrator | Application | Custom | Employee | OpenTelemetryCollector | Owner | Proxy | Viewer | RiskAuditor | ExternalIDP | Minibridge)`
...
Type: `enum(Default | RemoteApex | IDP | Minibridge)`
...
Type: `enum(Pod | Deployment | StatefulSet | Job | CronJob)`
