...
Type: `enum(Categories | Confidentiality | CustomDataTypes | Exploits | Keywords | Languages | Malcontents | Modality | Model | PIIs | Plugin | Provider | Relevance | Secrets | Size | Team | Tools | Topics | Workspace)`
...
Type: `enum(None | WebExtension | Acushield)`
