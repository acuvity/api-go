...
Type: `enum(Administrator | Application | Custom | Employee | OpenTelemetryCollector | Owner | Proxy | Viewer | RiskAuditor | ExternalIDP | Maxibridge)`
...
##### `dstPort` [`min_value=1.000000`,`max_value=65535.000000`]
...
##### `socketCookie` [`min_value=1.000000`]
...
##### `srcPort` [`min_value=1.000000`,`max_value=65535.000000`]
