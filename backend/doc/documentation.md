...
Type: `enum(All | Any | Empty | Equals | EqualsOrGreaterThan | EqualsOrLesserThan | Like | NotAny | NotEmpty | NotEquals)`
...
function webhook_output(result)
