...
type App struct {
	...
	Components AppComponentsList `json:"components" msgpack:"components" bson:"components" mapstructure:"components,omitempty"`
...
var AppAttributesMap = map[string]elemental.AttributeSpecification{
	...
	"Components": {
		AllowedChoices: []string{},
		BSONFieldName:  "components",
		ConvertedName:  "Components",
		Description:    `List of components for the application.`,
		Exposed:        true,
		Name:           "components",
		Orderable:      true,
		Stored:         true,
		SubType:        "appcomponent",
		Type:           "refList",
	},
	"CreateTime": {
		AllowedChoices: []string{},
...
type SparseApp struct {
	...
	// List of components for the application.
	Components *AppComponentsList `json:"components,omitempty" msgpack:"components,omitempty" bson:"components,omitempty" mapstructure:"components,omitempty"`
