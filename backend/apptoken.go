...
// AppTokenTypeValue represents the possible values for attribute "type".
type AppTokenTypeValue string

const (
	// AppTokenTypeDefault represents the value Default.
	AppTokenTypeDefault AppTokenTypeValue = "Default"
...
type AppToken struct {
	...
	Type AppTokenTypeValue `json:"type" msgpack:"type" bson:"type" mapstructure:"type,omitempty"`
...
func (o *AppToken) EncryptAttributes(encrypter elemental.AttributeEncrypter) (err error) {

	return nil
}

// DecryptAttributes decrypts the attributes marked as `encrypted` using the given decrypter.
func (o *AppToken) DecryptAttributes(encrypter elemental.AttributeEncrypter) (err error) {
...
issued for a particular machine.`,
	...
	"Opaque": {
		...
		CreationOnly:   true,
		Description: `This fields allows to set opaque key value pair that will be incorporated in the
token. All the keys will be prefixed with 'usr/' to make sure the system can
identify these opaque values. For instance if you add {k: v} then the
token will have {usr/k: v}. They are not stored as they may contain sensitive
user information.`,
...
won't be long lived.`,
	...
	"Type": {
		...
		Description: `Select the type of token. This will insert various claims to match pre
configured api authorizations.`,
		Exposed: true,
		Name:    "type",
		Stored:  true,
...
type SparseAppToken struct {
	...
	// Select the type of token. This will insert various claims to match pre
	// configured api authorizations.
	Type *AppTokenTypeValue `json:"type,omitempty" msgpack:"type,omitempty" bson:"type,omitempty" mapstructure:"type,omitempty"`
...
// EncryptAttributes encrypts the attributes marked as `encrypted` using the given encrypter.
func (o *SparseAppToken) EncryptAttributes(encrypter elemental.AttributeEncrypter) (err error) {

	return nil
}

// DecryptAttributes decrypts the attributes marked as `encrypted` using the given decrypter.
func (o *SparseAppToken) DecryptAttributes(encrypter elemental.AttributeEncrypter) (err error) {
...
type mongoAttributesAppToken struct {
	...
	Type           AppTokenTypeValue `bson:"type"`
...
type mongoAttributesSparseAppToken struct {
	...
	Transient      *bool              `bson:"transient,omitempty"`
	Type           *AppTokenTypeValue `bson:"type,omitempty"`
