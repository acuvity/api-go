...
type AppComponentEgress struct {
	...
	ProxyAssignPolicy string `json:"proxyAssignPolicy,omitempty" msgpack:"proxyAssignPolicy,omitempty" bson:"-" mapstructure:"proxyAssignPolicy,omitempty"`
...
func (o *AppComponentEgress) ValueForAttribute(name string) any {
	...
	case "proxyAssignPolicy":
		return o.ProxyAssignPolicy
...
and continue to be enforced. Default false.`,
	...
	"ProxyAssignPolicy": {
		AllowedChoices: []string{},
		Autogenerated:  true,
		ConvertedName:  "ProxyAssignPolicy",
		Description:    `The computed rego assign policy for the proxy.`,
		Exposed:        true,
		Name:           "proxyAssignPolicy",
		ReadOnly:       true,
		Transient:      true,
		Type:           "string",
	},
