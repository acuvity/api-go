...
func (o *Principal) Validate() error {
	...
	if err := elemental.ValidateStringInList("authType", string(o.AuthType), []string{"Certificate", "UserToken", "AppToken", "Hostname", "Token", "TierToken", "External"}, false); err != nil {
		errors = errors.Append(err)
	}
