...
// ToSparse returns the PACConfigsList converted to SparsePACConfigsList.
...
func (o *PACConfig) Doc() string {
	...
	return `PAC Config allows to create a custom PAC, with a selection of services enabled.`
}
...
func (o *PACConfig) EncryptAttributes(encrypter elemental.AttributeEncrypter) (err error) {

	return nil
}

// DecryptAttributes decrypts the attributes marked as `encrypted` using the given decrypter.
func (o *PACConfig) DecryptAttributes(encrypter elemental.AttributeEncrypter) (err error) {
...
func (o *PACConfig) DeepCopyInto(out *PACConfig) {
	...
	if err != nil {
		panic(fmt.Sprintf("Unable to deepcopy PACConfig: %s", err))
	}

	*out = *target.(*PACConfig)
}
...
func (o *PACConfig) Validate() error {
	...
	if err := elemental.ValidateRequiredExternal("providers", o.Providers); err != nil {
		requiredErrors = requiredErrors.Append(err)
	}
...
func (*PACConfig) SpecificationForAttribute(name string) elemental.AttributeSpecification {
	...
	if v, ok := PACConfigAttributesMap[name]; ok {
		return v
	}

	// We could not find it, so let's check on the lower case indexed spec map
	return PACConfigLowerCaseAttributesMap[name]
}

// AttributeSpecifications returns the full attribute specifications map.
func (*PACConfig) AttributeSpecifications() map[string]elemental.AttributeSpecification {

	return PACConfigAttributesMap
}
...
func (o *SparsePACConfig) GetBSON() (any, error) {
	...
	s := &mongoAttributesSparsePACConfig{}
...
// EncryptAttributes encrypts the attributes marked as `encrypted` using the given encrypter.
func (o *SparsePACConfig) EncryptAttributes(encrypter elemental.AttributeEncrypter) (err error) {

	return nil
}

// DecryptAttributes decrypts the attributes marked as `encrypted` using the given decrypter.
func (o *SparsePACConfig) DecryptAttributes(encrypter elemental.AttributeEncrypter) (err error) {
...
func (o *SparsePACConfig) DeepCopyInto(out *SparsePACConfig) {
	...
	target, err := copystructure.Copy(o)
	if err != nil {
		panic(fmt.Sprintf("Unable to deepcopy SparsePACConfig: %s", err))
	}

	*out = *target.(*SparsePACConfig)
}

type mongoAttributesPACConfig struct {
...
type mongoAttributesSparsePACConfig struct {
	ID          bson.ObjectId `bson:"_id,omitempty"`
