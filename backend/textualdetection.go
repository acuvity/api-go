...
type TextualDetection struct {
	...
	RedactedEnd int `json:"redactedEnd,omitempty" msgpack:"redactedEnd,omitempty" bson:"redactedend,omitempty" mapstructure:"redactedEnd,omitempty"`

	// The start position of the detection in the redacted data.
	RedactedStart int `json:"redactedStart,omitempty" msgpack:"redactedStart,omitempty" bson:"redactedstart,omitempty" mapstructure:"redactedStart,omitempty"`
...
func (o *TextualDetection) Validate() error {
	...
	if err := elemental.ValidateStringInList("type", string(o.Type), []string{"Keyword", "PII", "Secret"}, false); err != nil {
		errors = errors.Append(err)
	}
...
type mongoAttributesTextualDetection struct {
	...
	RedactedEnd   int                       `bson:"redactedend,omitempty"`
	RedactedStart int                       `bson:"redactedstart,omitempty"`
