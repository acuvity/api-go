...
type OrgSettings struct {
	...
	AIDomainsIndustryFilter []string `json:"AIDomainsIndustryFilter" msgpack:"AIDomainsIndustryFilter" bson:"aidomainsindustryfilter" mapstructure:"AIDomainsIndustryFilter,omitempty"`
...
func (o *OrgSettings) GetBSON() (any, error) {
	...
	s.AIDomainsIndustryFilter = o.AIDomainsIndustryFilter
	if o.ID != "" {
...
func (o *OrgSettings) SetBSON(raw bson.Raw) error {
	...
	o.AIDomainsIndustryFilter = s.AIDomainsIndustryFilter
	o.ID = s.ID.Hex()
...
func (o *OrgSettings) ToSparse(fields ...string) elemental.SparseIdentifiable {
	...
	for _, f := range fields {
		switch f {
		case "AIDomainsIndustryFilter":
			sp.AIDomainsIndustryFilter = &(o.AIDomainsIndustryFilter)
		case "ID":
			sp.ID = &(o.ID)
		case "accessPolicy":
...
func (o *OrgSettings) Patch(sparse elemental.SparseIdentifiable) {
	...
	if so.AIDomainsIndustryFilter != nil {
		o.AIDomainsIndustryFilter = *so.AIDomainsIndustryFilter
	}
	if so.ID != nil {
		o.ID = *so.ID
	}
...
func (o *OrgSettings) EncryptAttributes(encrypter elemental.AttributeEncrypter) (err error) {

	return nil
}

// DecryptAttributes decrypts the attributes marked as `encrypted` using the given decrypter.
func (o *OrgSettings) DecryptAttributes(encrypter elemental.AttributeEncrypter) (err error) {
...
func (o *OrgSettings) Validate() error {
	...
	if err := ValidateAIDomainIndustries("AIDomainsIndustryFilter", o.AIDomainsIndustryFilter); err != nil {
...
func (o *OrgSettings) ValueForAttribute(name string) any {
	...
	switch name {
	case "AIDomainsIndustryFilter":
		return o.AIDomainsIndustryFilter
	case "ID":
		return o.ID
	case "accessPolicy":
...
var OrgSettingsAttributesMap = map[string]elemental.AttributeSpecification{
	"AIDomainsIndustryFilter": {
		...
		BSONFieldName:  "aidomainsindustryfilter",
		ConvertedName:  "AIDomainsIndustryFilter",
		Description:    `If not empty, only report visited AI domains for the matching industries.`,
		Exposed:        true,
		Name:           "AIDomainsIndustryFilter",
		Stored:         true,
		SubType:        "string",
		Type:           "list",
	},
...
type SparseOrgSettings struct {
	// If not empty, only report visited AI domains for the matching industries.
	AIDomainsIndustryFilter *[]string `json:"AIDomainsIndustryFilter,omitempty" msgpack:"AIDomainsIndustryFilter,omitempty" bson:"aidomainsindustryfilter,omitempty" mapstructure:"AIDomainsIndustryFilter,omitempty"`
...
func (o *SparseOrgSettings) GetBSON() (any, error) {
	...
	if o.AIDomainsIndustryFilter != nil {
		s.AIDomainsIndustryFilter = o.AIDomainsIndustryFilter
	}
	if o.ID != nil {
		s.ID = bson.ObjectIdHex(*o.ID)
...
func (o *SparseOrgSettings) SetBSON(raw bson.Raw) error {
	...
	if s.AIDomainsIndustryFilter != nil {
		o.AIDomainsIndustryFilter = s.AIDomainsIndustryFilter
	}
	id := s.ID.Hex()
	o.ID = &id
...
func (o *SparseOrgSettings) ToPlain() elemental.PlainIdentifiable {
	...
	out := NewOrgSettings()
	if o.AIDomainsIndustryFilter != nil {
		out.AIDomainsIndustryFilter = *o.AIDomainsIndustryFilter
	}
	if o.ID != nil {
		out.ID = *o.ID
	}
...
// EncryptAttributes encrypts the attributes marked as `encrypted` using the given encrypter.
func (o *SparseOrgSettings) EncryptAttributes(encrypter elemental.AttributeEncrypter) (err error) {

	return nil
}

// DecryptAttributes decrypts the attributes marked as `encrypted` using the given decrypter.
func (o *SparseOrgSettings) DecryptAttributes(encrypter elemental.AttributeEncrypter) (err error) {
