...
// AccessPolicyTransportModeValue represents the possible values for attribute "transportMode".
type AccessPolicyTransportModeValue string

const (
	// AccessPolicyTransportModeGateway represents the value Gateway.
	AccessPolicyTransportModeGateway AccessPolicyTransportModeValue = "Gateway"

	// AccessPolicyTransportModeProxy represents the value Proxy.
	AccessPolicyTransportModeProxy AccessPolicyTransportModeValue = "Proxy"
)
...
type AccessPolicy struct {
	...
	TransportMode AccessPolicyTransportModeValue `json:"transportMode" msgpack:"transportMode" bson:"transportmode" mapstructure:"transportMode,omitempty"`
...
func (o *AccessPolicy) ToSparse(fields ...string) elemental.SparseIdentifiable {
	...
	for _, f := range fields {
		...
		case "transportMode":
			sp.TransportMode = &(o.TransportMode)
		case "updateTime":
...
func (o *AccessPolicy) Patch(sparse elemental.SparseIdentifiable) {
	...
	if so.TransportMode != nil {
		o.TransportMode = *so.TransportMode
	}
...
func (o *AccessPolicy) EncryptAttributes(encrypter elemental.AttributeEncrypter) (err error) {
	...
	for _, sub := range o.Match {
		...
		if err := sub.EncryptAttributes(encrypter); err != nil {
			return fmt.Errorf("unable to encrypt refList/refMap attribute 'Match' for 'AccessPolicy' (%s): %s", o.Identifier(), err)
		}
	}
...
func (o *AccessPolicy) DecryptAttributes(encrypter elemental.AttributeEncrypter) (err error) {
	...
	for _, sub := range o.Match {
		...
		if err := sub.DecryptAttributes(encrypter); err != nil {
			return fmt.Errorf("unable to decrypt refList/refMap attribute 'Match' for 'AccessPolicy' (%s): %w", o.Identifier(), err)
		}
	}
...
func (o *AccessPolicy) Validate() error {
	...
	if err := ValidateWebSchemeURL("redirectURL", o.RedirectURL); err != nil {
		errors = errors.Append(err)
	}
...
type SparseAccessPolicy struct {
	...
	// User-facing decisions (Unauthorized, Forbidden, Deny, Ask) are unaffected
	// and continue to be enforced. Default false.
	FailClose *bool `json:"failClose,omitempty" msgpack:"failClose,omitempty" bson:"failclose,omitempty" mapstructure:"failClose,omitempty"`
	...
	// Specify if this policy applies to transparent proxy or gateway.
	TransportMode *AccessPolicyTransportModeValue `json:"transportMode,omitempty" msgpack:"transportMode,omitempty" bson:"transportmode,omitempty" mapstructure:"transportMode,omitempty"`
...
func (o *SparseAccessPolicy) ToPlain() elemental.PlainIdentifiable {
	...
	if o.TransportMode != nil {
		out.TransportMode = *o.TransportMode
	}
	if o.UpdateTime != nil {
...
// EncryptAttributes encrypts the attributes marked as `encrypted` using the given encrypter.
func (o *SparseAccessPolicy) EncryptAttributes(encrypter elemental.AttributeEncrypter) (err error) {
	...
	if o.Match != nil {
		for _, sub := range *o.Match {
			...
			if err := sub.EncryptAttributes(encrypter); err != nil {
				return fmt.Errorf("unable to encrypt refList/refMap attribute 'Match' for 'AccessPolicy' (%s): %w", o.Identifier(), err)
			}
		}
	}
...
// DecryptAttributes decrypts the attributes marked as `encrypted` using the given decrypter.
func (o *SparseAccessPolicy) DecryptAttributes(encrypter elemental.AttributeEncrypter) (err error) {
...
type mongoAttributesSparseAccessPolicy struct {
	...
	FailClose           *bool                           `bson:"failclose,omitempty"`
	ImportHash          *string                         `bson:"importhash,omitempty"`
	ImportLabel         *string                         `bson:"importlabel,omitempty"`
