...
func (o *Detection) Identity() elemental.Identity {

	return elemental.Identity{}
}
func (o *Detection) Identifier() string {

	return ""
}
func (o *Detection) SetIdentifier(id string) {
...
func (o *Detection) Doc() string {

	return `Represent a detection.`
}

// EncryptAttributes encrypts the attributes marked as `encrypted` using the given encrypter.
func (o *Detection) EncryptAttributes(encrypter elemental.AttributeEncrypter) (err error) {

	return nil
}

// DecryptAttributes decrypts the attributes marked as `encrypted` using the given decrypter.
func (o *Detection) DecryptAttributes(encrypter elemental.AttributeEncrypter) (err error) {
