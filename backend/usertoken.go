...
const (
	// UserTokenClientTypeAcuctl represents the value Acuctl.
	UserTokenClientTypeAcuctl UserTokenClientTypeValue = "Acuctl"
...
// UserTokenTypeValue represents the possible values for attribute "type".
type UserTokenTypeValue string

const (
	// UserTokenTypeDefault represents the value Default.
	UserTokenTypeDefault UserTokenTypeValue = "Default"

	// UserTokenTypeDiscovery represents the value Discovery.
	UserTokenTypeDiscovery UserTokenTypeValue = "Discovery"
)
...
type UserToken struct {
	...
	// type.
	Type UserTokenTypeValue `json:"type" msgpack:"type" bson:"type" mapstructure:"type,omitempty"`
...
func (o *UserToken) EncryptAttributes(encrypter elemental.AttributeEncrypter) (err error) {

	return nil
}

// DecryptAttributes decrypts the attributes marked as `encrypted` using the given decrypter.
func (o *UserToken) DecryptAttributes(encrypter elemental.AttributeEncrypter) (err error) {
...
func (o *UserToken) Validate() error {
	...
	if err := elemental.ValidateStringInList("clientType", string(o.ClientType), []string{"None", "WebExtension", "Acushield", "Acuctl"}, false); err != nil {
	...
	if err := elemental.ValidateStringInList("type", string(o.Type), []string{"Default", "Discovery"}, false); err != nil {
		errors = errors.Append(err)
	}
...
var UserTokenAttributesMap = map[string]elemental.AttributeSpecification{
	...
	"ClientType": {
		AllowedChoices: []string{"None", "WebExtension", "Acushield", "Acuctl"},
...
won't be long lived.`,
	...
	"Type": {
		AllowedChoices: []string{"Default", "Discovery"},
		BSONFieldName:  "type",
		ConvertedName:  "Type",
		DefaultValue:   UserTokenTypeDefault,
		Description: `Select the type of token. This will insert additional claims related to the
type.`,
		Exposed: true,
		Name:    "type",
		Stored:  true,
...
type SparseUserToken struct {
	...
	// Select the type of token. This will insert additional claims related to the
	// type.
	Type *UserTokenTypeValue `json:"type,omitempty" msgpack:"type,omitempty" bson:"type,omitempty" mapstructure:"type,omitempty"`
...
// EncryptAttributes encrypts the attributes marked as `encrypted` using the given encrypter.
func (o *SparseUserToken) EncryptAttributes(encrypter elemental.AttributeEncrypter) (err error) {

	return nil
}

// DecryptAttributes decrypts the attributes marked as `encrypted` using the given decrypter.
func (o *SparseUserToken) DecryptAttributes(encrypter elemental.AttributeEncrypter) (err error) {
...
type mongoAttributesUserToken struct {
	...
	Type           UserTokenTypeValue       `bson:"type"`
...
type mongoAttributesSparseUserToken struct {
	...
	Transient      *bool                     `bson:"transient,omitempty"`
	Type           *UserTokenTypeValue       `bson:"type,omitempty"`
