...
func (o *GitbookToken) Doc() string {
	...
	return `Allows to exchange a Proofpoint AI Security token for a token signed for our
documentation.`
}
...
func (o *GitbookToken) EncryptAttributes(encrypter elemental.AttributeEncrypter) (err error) {

	return nil
}

// DecryptAttributes decrypts the attributes marked as `encrypted` using the given decrypter.
func (o *GitbookToken) DecryptAttributes(encrypter elemental.AttributeEncrypter) (err error) {
...
var GitbookTokenAttributesMap = map[string]elemental.AttributeSpecification{
	"Token": {
		...
		Autogenerated:  true,
		ConvertedName:  "Token",
		Description:    `The token to access gitbook. This is not a valid Proofpoint AI Security token.`,
		Exposed:        true,
		Name:           "token",
		ReadOnly:       true,
		Transient:      true,
...
// EncryptAttributes encrypts the attributes marked as `encrypted` using the given encrypter.
func (o *SparseGitbookToken) EncryptAttributes(encrypter elemental.AttributeEncrypter) (err error) {

	return nil
}

// DecryptAttributes decrypts the attributes marked as `encrypted` using the given decrypter.
func (o *SparseGitbookToken) DecryptAttributes(encrypter elemental.AttributeEncrypter) (err error) {
